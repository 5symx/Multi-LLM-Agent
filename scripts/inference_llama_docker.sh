...
do
    ...
    python inference_utils/toolbench/infer_pipeline_vllm.py \
        ...
        --planner_tokenizer_name_or_path "${MODELS_DIR}/${PLAN_MODEL}" \
        --caller_tokenizer_name_or_path "${MODELS_DIR}/${CAL_MODEL}" \
        --summarizer_tokenizer_name_or_path "${MODELS_DIR}/${SUM_MODEL}" \
        --planner_base_url "http://${LLAMA_HOST}:${PLAN_PORT}/v1" \
        --caller_base_url "http://${LLAMA_HOST}:${CAL_PORT}/v1" \
        --summarizer_base_url "http://${LLAMA_HOST}:${SUM_PORT}/v1" \
